...
#pragma warning restore CS8618
    ...
    [JsonIgnore]
    public Dictionary<string, string>? MetadataIdentifiers => ComickComicInfo.Comic.Links?
    ...
    [JsonIgnore] private ComicInfo? _rawComicInfo;

    [JsonIgnore]
    ComicInfo IComic.RawComicInfo => _rawComicInfo ??= new ComicInfo()
    {
    ...
    public async IAsyncEnumerable<ComickChapter> GetChapters(string language)
    {
        ...
        do
        {
            chapters = await MangaCli.Connector.GetClient().GetFromJsonAsync(
