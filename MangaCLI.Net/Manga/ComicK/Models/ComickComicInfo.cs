...
public class ComickComicInfo
{
    ...
    public class ComicInfo
    {
        ...
        public ComickContentRating ContentRating { get; init; }
        [JsonPropertyName("md_titles")]
        public List<ComickTitle> Titles { get; init; }
        [JsonPropertyName("md_comic_md_genres")]
        public List<ComickGenreWrapper> Genres { get; init; }
        [JsonPropertyName("md_covers")]
        public List<ComickCover> Covers { get; init; }
        [JsonPropertyName("mu_comics")]
        public ComickComics? ExtraComicInfo { get; init; }
        ...
        public class ComickGenreWrapper
        {
            ...
            public ComickGenreType Genre { get; init; }
        ...
        public class ComickComics
        {
            ...
            {
                [JsonPropertyName("mu_publishers")]
                public PublisherType Publisher { get; init; }
            ...
            public class ComicCategoryWrapper
            {
                ...
                public ComicCategoryType ComicCategory { get; init; }
